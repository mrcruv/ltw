...
<div class="row container-fluid">
    <div class="col-md-4 offset-md-1 text-center">
        ...
        <ul class="list-group list-group-flush">
            <li class="list-group-item"><small class="text-muted">Codice fiscale</small><h6
                        id="text_cf"><?php echo($cf); ?></h6>
                <a class="edit" title="Edit" data-toggle="tooltip" href="#" id="cf_e"><i
                            class="material-icons">&#xE254;</i></a>
                <a class="add" title="Add" data-toggle="tooltip" href="#" id="cf_a"><i
                            class="material-icons">&#xE161;</i></a>
            </li>
            <li class="list-group-item"><small class="text-muted">Partita IVA</small><h6
                        id="text_piva"><?php echo($piva); ?></h6>
                <a class="edit" title="Edit" data-toggle="tooltip" href="#" id="piva_e"><i class="material-icons">&#xE254;</i></a>
                <a class="add" title="Add" data-toggle="tooltip" href="#" id="piva_a"><i
                            class="material-icons">&#xE161;</i></a>
            </li>
            ...
            <li class="list-group-item"><small class="text-muted">PEC</small><h6 id="text_pec"><?php echo($pec); ?></h6>
                ...
                <a class="add" title="Add" data-toggle="tooltip" href="#" id="pec_a"><i
                            class="material-icons">&#xE161;</i></a>
            </li>
            <?php
            }
            ...
            if (mysqli_stmt_fetch($statement)) { ?>
            <li class="list-group-item"><small class="text-muted">Denominazione</small><h6
                        id="text_entityName"><?php echo($name); ?></h6>
            ...
            <li class="list-group-item"><small class="text-muted">Tipo</small><h6
                        id="text_entityType"><?php echo($type); ?></h6>
