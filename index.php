                        ...
                        <div class="tab" data-tab="pills-register">
                                ...
                                <div class="row mb-4">
                                    <div class="col-md d-flex justify-content-center">
                                        <div class="form-check mb-2 mb-md-0">
                                            <input class="form-check-input" type="checkbox" value="yes" id="term_check_entity" name="entity_term"/>
                                            <label class="form-check-label mb-2" for="term_check_entity">Accetta Termini & Condizioni</label>
                                        </div>
                                    </div>
                            ...
                            <form id="register_expert_form" action="<?php echo('scripts/register_expert.php'); ?>" method="post">
                                ...
                                <div class="row mb-4">
                                    <div class="col-md d-flex justify-content-center">
                                        <div class="form-check mb-2 mb-md-0">
                                            <input class="form-check-input" type="checkbox" value="yes" id="term_check_expert" name="expert_term"/>
